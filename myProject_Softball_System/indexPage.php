...
<body>
    ...
    <div class="container my-3">
        ...
        <ul class="nav nav-tabs" role="tablist">
            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="">上半季</a></li>
            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="">下半季</a></li>
            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="">全年度</a></li>
        </ul>
