    ...
    function GetSQLValueString($theValue, $theType) {
     ...
     if(isset($_POST["action"]) && ($_POST["action"]=="join")){
        ...
        if ($RecFindUser->num_rows>0){
            header("Location: login.php?errMsg=1&username={$_POST["m_username"]}");
        }else{
            //若沒有人使用該帳號則執行新增動作
            ...
            <div class="col-8">
                ...
                <div class="row">
                    <div class="w-50 d-flex">
                        <button id="loginBtn" type="button" class="btn btn-outline-primary w-100 m-4"
                            data-toggle="buttons">會員登入</button>
                    </div>
                    <div class="w-50 d-flex justify-content-center">
                        <button id="signBtn" type="button" class="btn btn-outline-primary w-100 m-4"
                ...
                <div class="row">
                    <div class="col">
                        <form method="post" action="" name="formJoin" id="formJoin" onSubmit="return checkForm();">
                            <div class=""><p class="text-center">帳號資訊<span class="fontsmClass">(<sup class="text-danger"> * </sup>為必填欄位)</span> </p></div> 
